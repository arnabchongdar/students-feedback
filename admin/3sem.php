<html>
	...
	<body>
		...
		<?php
   		...
   		$sql1_1= "SELECT AVG(grade1) FROM M302_1";//first database start
		$sql1_2= "SELECT AVG(grade2) FROM M302_1";
		$sql1_3= "SELECT AVG(grade3) FROM M302_1";
		$sql1_4= "SELECT AVG(grade4) FROM M302_1";
		$sql1_5= "SELECT AVG(grade5) FROM M302_1";
		$sql1_6= "SELECT AVG(grade6) FROM M302_1";
		$sql1_7= "SELECT AVG(grade7) FROM M302_1";
		$sql1_8= "SELECT AVG(grade8) FROM M302_1";
		...
		$sql2_1= "SELECT AVG(grade1) FROM M302_2";//second database starts
		$sql2_2= "SELECT AVG(grade2) FROM M302_2";
		$sql2_3= "SELECT AVG(grade3) FROM M302_2";
		$sql2_4= "SELECT AVG(grade4) FROM M302_2";
		$sql2_5= "SELECT AVG(grade5) FROM M302_2";
		$sql2_6= "SELECT AVG(grade6) FROM M302_2";
		$sql2_7= "SELECT AVG(grade7) FROM M302_2";
		$sql2_8= "SELECT AVG(grade8) FROM M302_2";
		...
		$sql3_1= "SELECT AVG(grade1) FROM MCS301";//THIRD database starts
		$sql3_2= "SELECT AVG(grade2) FROM MCS301";
		$sql3_3= "SELECT AVG(grade3) FROM MCS301";
		$sql3_4= "SELECT AVG(grade4) FROM MCS301";
		$sql3_5= "SELECT AVG(grade5) FROM MCS301";
		$sql3_6= "SELECT AVG(grade6) FROM MCS301";
		$sql3_7= "SELECT AVG(grade7) FROM MCS301";
		$sql3_8= "SELECT AVG(grade8) FROM MCS301";
		...
		$sql4_1= "SELECT AVG(grade1) FROM EC301";//FOURTH database starts
		$sql4_2= "SELECT AVG(grade2) FROM EC301";
		$sql4_3= "SELECT AVG(grade3) FROM EC301";
		$sql4_4= "SELECT AVG(grade4) FROM EC301";
		$sql4_5= "SELECT AVG(grade5) FROM EC301";
		$sql4_6= "SELECT AVG(grade6) FROM EC301";
		$sql4_7= "SELECT AVG(grade7) FROM EC301";
		$sql4_8= "SELECT AVG(grade8) FROM EC301";
		...
		$sql5_1= "SELECT AVG(grade1) FROM EC302";//Fifth database starts
		$sql5_2= "SELECT AVG(grade2) FROM EC302";
		$sql5_3= "SELECT AVG(grade3) FROM EC302";
		$sql5_4= "SELECT AVG(grade4) FROM EC302";
		$sql5_5= "SELECT AVG(grade5) FROM EC302";
		$sql5_6= "SELECT AVG(grade6) FROM EC302";
		$sql5_7= "SELECT AVG(grade7) FROM EC302";
		$sql5_8= "SELECT AVG(grade8) FROM EC302";
		...
		$sql6_1= "SELECT AVG(grade1) FROM EC303";//Sixth database starts
		$sql6_2= "SELECT AVG(grade2) FROM EC303";
		$sql6_3= "SELECT AVG(grade3) FROM EC303";
		$sql6_4= "SELECT AVG(grade4) FROM EC303";
		$sql6_5= "SELECT AVG(grade5) FROM EC303";
		$sql6_6= "SELECT AVG(grade6) FROM EC303";
		$sql6_7= "SELECT AVG(grade7) FROM EC303";
		$sql6_8= "SELECT AVG(grade8) FROM EC303";
		...
		$sql7_1= "SELECT AVG(grade1) FROM EC304";//Seventh database starts
		$sql7_2= "SELECT AVG(grade2) FROM EC304";
		$sql7_3= "SELECT AVG(grade3) FROM EC304";
		$sql7_4= "SELECT AVG(grade4) FROM EC304";
		$sql7_5= "SELECT AVG(grade5) FROM EC304";
		$sql7_6= "SELECT AVG(grade6) FROM EC304";
		$sql7_7= "SELECT AVG(grade7) FROM EC304";
		$sql7_8= "SELECT AVG(grade8) FROM EC304";
		...
		$sql8_1= "SELECT AVG(grade1) FROM MCS391";//Eighth database starts
		$sql8_2= "SELECT AVG(grade2) FROM MCS391";
		$sql8_3= "SELECT AVG(grade3) FROM MCS391";
		$sql8_4= "SELECT AVG(grade4) FROM MCS391";
		$sql8_5= "SELECT AVG(grade5) FROM MCS391";
		$sql8_6= "SELECT AVG(grade6) FROM MCS391";
		$sql8_7= "SELECT AVG(grade7) FROM MCS391";
		$sql8_8= "SELECT AVG(grade8) FROM MCS391";
		...
		$sql9_1= "SELECT AVG(grade1) FROM EC391";//ninth database starts
		$sql9_2= "SELECT AVG(grade2) FROM EC391";
		$sql9_3= "SELECT AVG(grade3) FROM EC391";
		$sql9_4= "SELECT AVG(grade4) FROM EC391";
		$sql9_5= "SELECT AVG(grade5) FROM EC391";
		$sql9_6= "SELECT AVG(grade6) FROM EC391";
		$sql9_7= "SELECT AVG(grade7) FROM EC391";
		$sql9_8= "SELECT AVG(grade8) FROM EC391";
